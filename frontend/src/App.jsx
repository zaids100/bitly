        ...
        <div className="bg-gray-900 mt-8 px-8 py-6 rounded-xl shadow-xl max-w-4xl w-full">
          ...
          <div className="flex flex-col gap-5">
            ...
            <button
              ...
              className="w-72 bg-gradient-to-r from-blue-500 to-teal-500 text-white my-3 py-3 px-6 rounded-lg shadow-md hover:from-blue-600 hover:to-teal-600 transition-all flex items-center justify-center gap-2"
            >
